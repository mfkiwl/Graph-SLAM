...
#
# For measurements, it  senses the x- and y-distance to landmarks. This is different from range and bearing as
# commonly studied in the literature, but this makes it much easier to implement the essentials of SLAM without cluttered math.
#
...
class Robot:
    ...
    # --------
    # move: attempts to move Robot by dx, dy. If outside world boundary, then the move does nothing and instead returns failure
    #
    def move(self, dx, dy):
    ...
    def sense(self):
        ...
        for index, each_landmark in enumerate(self.landmarks):
                dx, dy = each_landmark[0] - self.x, each_landmark[1] - self.y
